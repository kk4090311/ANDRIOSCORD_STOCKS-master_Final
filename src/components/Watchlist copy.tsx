...
const Watchlistcopy: FC<TopMoversProps> = ({ stockData, coinData}) => {
  ...
  return (
    ...
    >
      <Text style={styles.watchlistText}>我的最愛(市值前30名)</Text>
      <View
      ...
      >
        <NestableScrollContainer>
            <NestableDraggableFlatList
              ...
              onDragEnd={({ data }) => {
                dispatch(watchlistcopyActions.updateCoinData(data));
              }}
